...
UPlayerAttackState_2::UPlayerAttackState_2()
{
}

void UPlayerAttackState_2::EnterState()
{
	Super::EnterState();
	...
	if (Character && AttackMontage)
	{
		...
		{
			AnimInst->OnMontageEnded.AddDynamic(this, &UPlayerAttackState_2::OnMontageEnded);
		}
	}
}

void UPlayerAttackState_2::UpdateState(float DeltaTime)
{
...
void UPlayerAttackState_2::ExitState()
{
	Super::ExitState();
	SetCanMontageExit(false);
	...
	if (Character)
	{
		if (UAnimInstance* AnimInst = Character->GetMesh()->GetAnimInstance())
		{
			AnimInst->OnMontageEnded.RemoveDynamic(this, &UPlayerAttackState_2::OnMontageEnded);
		}
	}
}

void UPlayerAttackState_2::OnMontageEnded(UAnimMontage* Montage, bool bInterrupted)
{
